...
public class CoralMoveManager : MonoBehaviour {
	...
	void Start () {
		...
		position = new Vector2 (stageDimensions.x * 1.3f, Random.Range (-stageDimensions.y + .8f, -stageDimensions.y + 1.2f));
		// Randomize size
	...
	public void resetPosition() {
		position.Set (stageDimensions.x * 1.3f, Random.Range (-stageDimensions.y + .8f, -stageDimensions.y + 1.2f));
	}
